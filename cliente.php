...
include "conecta.php";
   ...
   $rowarq = $listaarq -> fetch();
    ...
    {
        $cliente =$conn -> query("update cliente set deleted = now() where cod_cliente = ".$_GET['codarq']) -> fetch();
    ...
    {
        $cliente = $conn -> query ("update cliente set deleted = null where cod_cliente = ".$_GET['codrest']) -> fetch();
        header('location: cliente.php');
    }
    ...
    {
        $cliente = $conn -> query ("delete from cliente where cod_cliente = ".$_GET['coddel']) -> fetch();
        header('location: cliente.php');
    }
